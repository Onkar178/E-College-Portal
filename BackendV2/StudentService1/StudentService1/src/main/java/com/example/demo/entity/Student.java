...
public class Student {
    ...
    @OneToMany(mappedBy = "student", cascade = CascadeType.ALL)
//    @JsonIgnoreProperties({"student", "course"}) // ignore both to avoid deep recursion
	...
	public Student(int uid, String firstName, String lastName, String addressLine1, String addressLine2,
			City city, Set<RegisteredEvent> registeredEvents, Set<CourseEnrollment> courseEnrollment,
			Set<PlacementApplication> applications) {
		super();
		this.uid = uid;
